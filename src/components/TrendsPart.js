...
import '../components/styles/trends.css';
  ...
  const [state, setstate] = useState([
    {
      ...
      hastage: "#RK, #Samshera",
      image:
        "https://pbs.twimg.com/media/FWe6rr0UIAEAikx?format=jpg&name=360x360",
    },
    {
      id: 2,
      ...
      image:
        "https://pbs.twimg.com/semantic_core_img/1255575536824233984/CiLy4der?format=jpg&name=240x240",
    },
    {
      id: 3,
      ...
      hastage: "#war",
      image:
        "https://pbs.twimg.com/semantic_core_img/1543517179382927360/ufOFTuY_?format=jpg&name=240x240",
    },
    {
      id: 4,
      ...
      hastage: "#Results",
      image:
        "https://pbs.twimg.com/card_img/1543842809077059585/02QaFg5b?format=jpg&name=small",
    },
    {
      id: 5,
      ...
      hastage: "#Miss World",
      image:
        "https://pbs.twimg.com/semantic_core_img/1543796180475187202/8hQtrwW5?format=jpg&name=240x240",
    },
  ]);
    ...
    <>
      <div className="keywords">
        <div className="key">
          ...
          <div className="data-sroll">
            {state.map((item) => (
              <div key={item.id} className="data">
                <div>
                  <div className="tweet-heading">{item.tweetHeading}</div>
